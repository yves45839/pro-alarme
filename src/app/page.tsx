...
const agentSecurityImage = "/images/agent-securite.png" as const;
const technicianImage = "/images/Technicien.png" as const;
const telesurveillanceImage = "/images/telesurveillance.png" as const;
